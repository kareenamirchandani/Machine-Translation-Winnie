...
# Some of the sentences have commas in them which compliactes things
...
with open('../sunbird_split_new.json', 'w') as fout:
    json.dump(dictionary_list, fout)

# Do we want to treat this as a multilabel or a multiclass problem?
# I think it would be better to treat is as a multilabel problem,
# to account for the possibility of code mixing

...
df = pd.read_csv("SALT_MT560_split_word_no_spaces.csv", encoding='utf-8') #ISO-8859-1

df_labels = df[["English", "Luganda", "Runyankole", "Ateso", "Lugbara", "Acholi","Swahili"]]
...
# Load the base model
base_model = tf.keras.models.load_model('lang_classifier_softmax4.h5')

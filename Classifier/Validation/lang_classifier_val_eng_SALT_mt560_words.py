...
eng_list = [item.split() for item in eng_list]
eng_list = list(itertools.chain.from_iterable(eng_list))

nyn_list = [item.split() for item in nyn_list]
nyn_list = list(itertools.chain.from_iterable(nyn_list))

swa_list = [item.split() for item in swa_list]
swa_list = list(itertools.chain.from_iterable(swa_list))

ach_list = [item.split() for item in ach_list]
ach_list = list(itertools.chain.from_iterable(ach_list))

teo_list = [item.split() for item in teo_list]
teo_list = list(itertools.chain.from_iterable(teo_list))

lug_list = [item.split() for item in lug_list]
lug_list = list(itertools.chain.from_iterable(lug_list))

lgg_list = [item.split() for item in lgg_list]
lgg_list = list(itertools.chain.from_iterable(lgg_list))
...
print(len(nyn_list))
validation_sentence = nyn_list[0:100000]
